 ...
 *
 * Вынесено в компонент, потому что суммы обычно встречаются на многих экранах
 * и должны выглядеть одинаково: неразрывные разряды, символ валюты,
 * опциональные копейки, табличные цифры для выравнивания в колонке.
 */
