<script setup>
/**
 * FxTooltip — всплывающая подсказка над обёрнутым элементом (пояснение к
 * формуле комиссии, расшифровка статуса). Только hover/focus, без интерактива
 * внутри: для меню есть FxDropdown.
 */
defineProps({
