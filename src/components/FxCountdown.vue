<script setup>
/**
 * FxCountdown — обратный отсчёт до дедлайна: приём заявок, шаг аукциона.
 *
 * Тикает раз в секунду от переданного времени окончания. За `warnAt` секунд до
 * нуля подсвечивается жёлтым, за `dangerAt` — красным: в торговом зале это
 * основной сигнал «пора делать ставку».
 */
