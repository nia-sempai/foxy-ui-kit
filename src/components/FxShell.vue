 ...
 *
 * Сайдбар намеренно светлый: в интерфейсах с плотными таблицами тёмная колонка
 * перетягивает внимание с данных. Цвета берутся из темы, поэтому под конкретный
 * проект каркас перекрашивается без правок разметки.
 *
